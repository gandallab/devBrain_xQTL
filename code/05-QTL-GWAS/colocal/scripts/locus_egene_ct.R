...
egene <- fread(paste0(
    "/u/project/gandalm/cindywen/isoform_twas/eqtl_new/results/", args$type, "_nominal_", args$hcp, "hcp/significant_assoc.txt"
), data.table = F)
...
write.table(egene_list, paste0(
    "/u/project/gandalm/cindywen/isoform_twas/colocal/results_", args$type, "_", args$hcp, "hcp_eqtl/", args$trait, "/locus_", args$locus, "/locus_egene.txt"
