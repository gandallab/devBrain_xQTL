...
./salmon-latest_linux_x86_64/bin/salmon quant -i ${SALMON_INDEX} -l A -1 ${IN_FASTQS_R1} -2 ${IN_FASTQS_R2} --validateMappings --useEM --numBootstraps 50 --seqBias --gcBias -p 12 -o ${SAMPLE_PATH} --dumpEq
