...
#$ -wd /u/project/gandalm/cindywen/isoform_twas/genotype/all_data/isec_R2_greater_than_3/ancestry/
#$ -o /u/project/gandalm/cindywen/isoform_twas/genotype/log/job.out.new.mega.pca.ancestry
#$ -m a
