...
#$ -j y
#$ -o /u/project/gandalm/cindywen/isoform_twas/isoqtl_new/log/job.out.gtex.qtl.chr.tri
#$ -m a
#$ -t 1-22
...
cov=/u/project/gandalm/cindywen/isoform_twas/isoqtl_new/data/eur/tri_specific/tri${tri}_${num_hcp}HCP_cov.txt
rel_file=/u/project/gandalm/cindywen/isoform_twas/genotype/all_data/isec_R2_greater_than_3/ancestry/related.txt
outdir=/u/project/gandalm/cindywen/isoform_twas/isoqtl_new/results/tri${tri}_nominal_${num_hcp}hcp/
