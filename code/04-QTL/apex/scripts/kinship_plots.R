...
argp <- add_argument(argp, "--out_file", help="Output file")
argp <- add_argument(argp, "--kinship_method", help="Kinship method")
argp <- add_argument(argp, "--kinship_threshold", help="Kinship threshold")
argp <- add_argument(argp, "--keep_id", help="Subjects to keep")
...
ggsave(argv$out_file, plot=p, width=6, height=6)
