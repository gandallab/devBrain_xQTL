...
#$ -pe shared 6
#$ -cwd
#$ -o /u/project/gandalm/cindywen/isoform_twas/sqtl_new/log/job.out.call.nominal.walker
#$ -m a
#$ -j y

n_hcp=$1
dir=/u/project/gandalm/cindywen/isoform_twas/sqtl_new/results/Walker_nominal_${n_hcp}hcp/
