...
#$ -pe shared 4
#$ -j y
#$ -o /u/project/gandalm/cindywen/isoform_twas/sqtl_new/log/job.out.walker.perm
#$ -m a
#$ -t 1-100
...
outdir=/u/project/gandalm/cindywen/isoform_twas/sqtl_new/results/Walker_perm_${num_hcp}hcp/
list=/u/project/gandalm/cindywen/isoform_twas/sqtl_new/code/walker_samples.txt
