...
#$ -cwd
#$ -o /u/project/gandalm/cindywen/isoform_twas/sqtl_new/log/job.out.call.perm.hdbr
#$ -m a
#$ -j y

n_hcp=$1
dir=/u/project/gandalm/cindywen/isoform_twas/sqtl_new/results/HDBR_perm_${n_hcp}hcp/
