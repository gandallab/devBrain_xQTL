...
#$ -pe shared 4
#$ -j y
#$ -o /u/project/gandalm/cindywen/isoform_twas/sqtl_new/log/job.out.hdbr.nominal
#$ -m a
#$ -t 1-100
...
outdir=/u/project/gandalm/cindywen/isoform_twas/sqtl_new/results/HDBR_nominal_${num_hcp}hcp/
