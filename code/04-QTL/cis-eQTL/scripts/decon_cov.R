...
p <- arg_parser("Generate covariates with various number of HCP, cell type/group specific")
...
write.table(cov, paste0(args$outdir, args$prefix, "_", num_hcp, "HCP_cov.txt"), quote = F, row.names = F, col.names = T, sep = "\t")
